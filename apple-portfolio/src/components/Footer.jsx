    ...
    <footer id="contact" className="py-16 px-6 border-t border-gray-200 dark:border-white/10 mt-24 selection:bg-gray-300 dark:selection:bg-gray-700 transition-colors duration-300">
      <div className="max-w-4xl mx-auto text-center space-y-8">
        ...
        <div className="pt-8 flex justify-center gap-6">
          <a href="https://github.com/pyps0990-alt" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors duration-300">
          ...
          <a href="https://linkedin.com/in/yijia-chen" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-blue-600 dark:hover:text-blue-500 transition-colors duration-300">
